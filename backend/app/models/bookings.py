...
class Booking(Base):
    ...
    seat_in_event_id = Column(BigInteger, ForeignKey('seats_in_events.seat_in_event_id'), unique=True, nullable=False)
    ...
    seat_in_event = relationship("SeatInEvent", uselist=False, back_populates="booking")
